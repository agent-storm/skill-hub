...
export default function NavBar() {
    return (
        <div className="drop-shadow-2xl fixed z-10 right-[40%] bottom-10 w-96 h-20 flex flex-row content-center items-center justify-evenly text-white bg-white dark:bg-gray-900 shadow-lg rounded-full overflow-hidden">
